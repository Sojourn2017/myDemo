...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _util_translate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/translate */ \"./src/util/translate.js\");\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! fs */ \"fs\");\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _util_writeLog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/writeLog */ \"./src/util/writeLog.js\");\n/* harmony import */ var _util_getClientIP__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util/getClientIP */ \"./src/util/getClientIP.js\");\n\n\n\n\nconst API = {};\n/**\r\n * 首页\r\n */\n\nAPI[\"/\"] = API[\"/index\"] = function (req, res, pathName = \"/index.html\", contextType = \"text/html\") {\n  fs__WEBPACK_IMPORTED_MODULE_1___default.a.readFile(\"./src/static\" + pathName, (err, data) => {\n    if (err) {\n      Object(_util_writeLog__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"indexPage error: \" + err, 1);\n      res.writeHead(404, {\n        \"content-type\": `text/plain`\n      });\n      res.end(\"404 Not Found\");\n    } else {\n      res.writeHead(200, {\n        \"content-type\": contextType\n      });\n      res.end(data);\n    }\n  });\n};\n/**\r\n * 翻译接口\r\n */\n\n\nAPI[\"/translate\"] = function (req, res) {\n  let chunks = [];\n  let size = 0;\n  req.on(\"data\", function (chunk) {\n    chunks.push(chunk);\n    size += chunk.length;\n  });\n  req.on(\"end\", async function () {\n    let buf = Buffer.concat(chunks, size);\n    let str = buf.toString(\"utf8\");\n    Object(_util_writeLog__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(`${Object(_util_getClientIP__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(req)} translate params: ${str} `);\n    let params = JSON.parse(str);\n    let queryResult = {};\n\n    try {\n      await _util_translate__WEBPACK_IMPORTED_MODULE_0__[\"default\"].translate(params, params.engine).then(result => {\n        queryResult = Object.assign(queryResult, result);\n      }).catch(err => {\n        Object(_util_writeLog__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"translate error: \" + err, 1);\n      });\n    } catch (e) {\n      Object(_util_writeLog__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"translate error: \" + err, 1);\n    }\n\n    res.writeHead(200, {\n      \"content-type\": `application/json; charset=\"utf-8`\n    });\n    res.end(JSON.stringify(queryResult));\n  });\n};\n\nAPI[\"/audio\"] = function (req, res) {\n  let chunks = [];\n  let size = 0;\n  req.on(\"data\", function (chunk) {\n    chunks.push(chunk);\n    size += chunk.length;\n  });\n  req.on(\"end\", async function () {\n    let buf = Buffer.concat(chunks, size);\n    let str = buf.toString(\"utf8\");\n    Object(_util_writeLog__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(`${Object(_util_getClientIP__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(req)} translate params: ${str} `);\n    let params = JSON.parse(str);\n    let queryResult = {};\n\n    try {\n      await _util_translate__WEBPACK_IMPORTED_MODULE_0__[\"default\"].audio(params.text, params.engine).then(uri => {\n        queryResult = Object.assign(queryResult, {\n          audioUri: uri\n        });\n      }).catch(err => {\n        Object(_util_writeLog__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"audio error: \" + err, 1);\n      });\n    } catch (e) {\n      Object(_util_writeLog__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\"audio error: \" + err, 1);\n    }\n\n    res.writeHead(200, {\n      \"content-type\": `application/json; charset=\"utf-8`\n    });\n    res.end(JSON.stringify(queryResult));\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (API);\n\n//# sourceURL=webpack:///./src/router/api.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var translation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! translation.js */ \"./node_modules/translation.js/dist/tjs.node.es.js\");\n/**\r\n * 调用翻译\r\n */\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  translate(queryObj, api = 'baidu') {\n    return translation_js__WEBPACK_IMPORTED_MODULE_0__[api].translate(queryObj);\n  },\n\n  audio(queryObj, api = 'baidu') {\n    return translation_js__WEBPACK_IMPORTED_MODULE_0__[api].audio(queryObj);\n  }\n\n});\n\n//# sourceURL=webpack:///./src/util/translate.js?");

/***/ }),

/***/ "./src/util/writeLog.js":
/*!******************************!*\
  !*** ./src/util/writeLog.js ***!
  \******************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fs */ \"fs\");\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_0__);\n/**\r\n * 访问日志\r\n */\n\n\nfunction createDir(dirArr) {\n  let createPathList = dirArr.filter(p => {\n    return !fs__WEBPACK_IMPORTED_MODULE_0___default.a.existsSync(p);\n  });\n  if (createPathList.length === 0) return;\n  createPathList.forEach(p => {\n    try {\n      fs__WEBPACK_IMPORTED_MODULE_0___default.a.mkdirSync(p);\n    } catch (e) {\n      console.log(e);\n    }\n  });\n}\n\nfunction writeErr(e) {\n  let handleType = fs__WEBPACK_IMPORTED_MODULE_0___default.a.existsSync('./logs/error.log') ? 'appendFile' : 'writeFile';\n  fs__WEBPACK_IMPORTED_MODULE_0___default.a[handleType](\"./logs/error.log\", `${new Date()}: ${e}\\r\\n`, e => {});\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (function (log, isWriteErr) {\n  createDir([\"./logs\"]);\n  let p = isWriteErr ? \"./logs/error.log\" : \"./logs/log.log\";\n  let handleType = fs__WEBPACK_IMPORTED_MODULE_0___default.a.existsSync(p) ? 'appendFile' : 'writeFile';\n  fs__WEBPACK_IMPORTED_MODULE_0___default.a[handleType](p, `${new Date()}: ${log} \\r\\n`, err => {\n    if (err) {\n      writeErr(err);\n    }\n  });\n});\n\n//# sourceURL=webpack:///./src/util/writeLog.js?");
