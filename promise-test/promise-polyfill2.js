    ...
    if (_this.state === "pending") {
      typeof onFulfilled === "function" &&
        _this.onFulfilledStack.push(
          executeCallbackAsync.bind(promise)(onFulfilled)
        );
      typeof onRejected === "function" &&
        _this.onRejectedStack.push(
          executeCallbackAsync.bind(promise)(onRejected)
        );
    } else if (_this.state === "fulfilled") {
      typeof onFulfilled === "function" &&
        executeCallbackAsync.bind(promise)(onFulfilled)(_this.value);
    } else if (_this.state === "rejected") {
      typeof onRejected === "function" &&
        executeCallbackAsync.bind(promise)(onRejected)(_this.reason);
    }
  });
...
function executeCallbackAsync(callback) {
  ...
  return function(param) {
    setTimeout(function() {
      try {
        var x = callback(param);
        resolvePromise(_this, x, resolve.bind(_this), reject.bind(_this));
      } catch (e) {
        reject(e);
      }
    });
