  ...
  <div class="common_chat-wrapper">
    <div class="common_chat-inner">
      ...
      <div class="common_chat-footer">
        <div>
          <!-- 表情、文件选择等操作 -->
          <common-chat-tool class="opr-wrapper" @emoji="setInputDiv"></common-chat-tool>
          <!-- 聊天输入框 -->
...
<script>
import commonChatTool from "./common-chat-tool";
